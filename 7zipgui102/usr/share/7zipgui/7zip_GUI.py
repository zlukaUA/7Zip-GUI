...
LANGUAGES = {
        ...
        "about_button": "About",
        "language_button": "Language (En/Uk/Ru/Tr)",
    ...
    "uk": {
        "window_title": "Графічний інтерфейс 7Zip",
        "about_title": "Про програму",
        "about_text": "Інтерфейс архівування, подібний до 7Zip\n\nВерсія: 1.0.3\nРозробник: А. Серхат КІЛІЧОГЛУ \ngithub.com/shampuan \nРозробник 7zip: Ігор Павлов \nЛіцензія: Ліцензія MIT \n\nПереклад: UALinux.com",
        "source_group_title": "Вихідні файли/папки",
        "add_files_button": "Додати файли...",
        "add_folder_button": "Додати папку...",
        "remove_selected_button": "Видалити вибране",
        "drag_drop_placeholder": "Перетягування",
        "target_group_title": "Ціль",
        "archive_label": "Архів:",
        "browse_button": "Переглянути...",
        "archive_format_label": "Формат архіву:",
        "compression_group_title": "Налаштування стиснення",
        "compression_level_label": "Рівень стиснення:",
        "level_store": "Зберігати (без стиснення)",
        "level_fastest": "Найшвидший",
        "level_fast": "Швидкий",
        "level_normal": "Нормальний",
        "level_maximum": "Максимальний",
        "level_ultra": "Ультра",
        "compression_method_label": "Метод стиснення:",
        "dictionary_size_label": "Розмір словника:",
        "threads_label": "Потоки процесора:",
        "options_group_title": "Параметри архівування",
        "update_mode_label": "Режим оновлення:",
        "update_add_replace": "Додати та замінити файли",
        "update_only_update": "Оновити існуючі файли",
        "update_synchronize": "Синхронізувати",
        "update_add_no_replace": "Додати файли (не замінювати існуючий)",
        "password_label": "Пароль:",
        "password_repeat_label": "Повторіть пароль:",
        "encrypt_filenames_checkbox": "Зашифрувати імена файлів",
        "show_password_checkbox": "Показати пароль",
        "solid_block_checkbox": "Архівування суцільного блоку",
        "split_volumes_checkbox": "Розділити на томи",
        "split_placeholder": "Вибрати або ввести розмір",
        "ok_button": "Архівувати",
        "cancel_button": "Скасувати",
        "about_button": "Про програму",
        "language_button": "Мова (En/Uk/Ru/Tr)",
        "password_mismatch_title": "Невідповідність паролів",
        "password_mismatch_message": "Паролі не збігаються!",
        "options_summary_title": "Підсумок параметрів",
        "summary_source_files": "--- Джерело Файли/Папки ---",
        "summary_selected_items": "Вибрані елементи:",
        "summary_archive_settings": "--- Налаштування архіву ---",
        "summary_archive_path": "Шлях до архіву:",
        "summary_archive_format": "Формат архіву:",
        "summary_compression_settings": "--- Налаштування стиснення ---",
        "summary_compression_level": "Рівень стиснення:",
        "summary_compression_method": "Метод стиснення:",
        "summary_dictionary_size": "Розмір словника:",
        "summary_cpu_threads": "Потоки процесора:",
        "summary_archive_options": "--- Налаштування архівування ---",
        "summary_update_mode": "Режим оновлення:",
        "summary_password_set": "Набір паролів:",
        "summary_encrypt_filenames": "Зашифрувати імена файлів:",
        "summary_solid_block": "Архівування суцільного блоку:",
        "summary_split_volumes": "Розділити на томи:",
        "summary_split_size": "Розмір розділення:",
        "summary_none": "Немає",
        "summary_start_compression": "Стиснення розпочнеться з цими налаштуваннями.",
        "no_source_selected": "Файли чи папки не вибрано.",
        "compression_command_success_title": "Архівування успішне",
        "compression_command_success_message": "Архів створено успішно!",
        "compression_command_error_title": "Помилка архівування",
        "compression_command_error_message": "Під час архівування сталася помилка:",
        "command_not_found_message": "Команда 7z не знайдена. Переконайтеся, що p7zip-full встановлено та 7z знаходиться у вашому PATH.",
        "progress_dialog_title": "Прогрес архівування",
        "progress_label_text_initial": "Триває архівування...",
        "progress_status_label": "Стан:",
        "cancel_compression_button": "Скасувати",
        "default_archive_basename": "новий_архів"
    },
    "ru": {
        "window_title": "7Zip GUI",
        "about_title": "О программе",
        "about_text": "Интерфейс архивирования, похожий на 7Zip\n\nВерсия: 1.0.3\nРазработчик: А. Серхат КИЛИЧОГЛУ \ngithub.com/shampuan \nСопровождающий 7zip: Игорь Павлов \nЛицензия: MIT License \n\nПеревод: UALinux.com",
        "source_group_title": "Исходные файлы/папки",
        "add_files_button": "Добавить файлы...",
        "add_folder_button": "Добавить папку...",
        "remove_selected_button": "Удалить выбранные",
        "drag_drop_placeholder": "Перетащить",
        "target_group_title": "Цель",
        "archive_label": "Архив:",
        "browse_button": "Просмотреть...",
        "archive_format_label": "Формат архива:",
        "compression_group_title": "Настройки сжатия",
        "compression_level_label": "Уровень сжатия:",
        "level_store": "Хранить (без сжатия)",
        "level_fastest": "Самый быстрый",
        "level_fast": "Быстрый",
        "level_normal": "Нормальный",
        "level_maximum": "Максимальный",
        "level_ultra": "Ультра",
        "compression_method_label": "Метод сжатия:",
        "dictionary_size_label": "Размер словаря:",
        "threads_label": "Потоки ЦП:",
        "options_group_title": "Параметры архивирования",
        "update_mode_label": "Режим обновления:",
        "update_add_replace": "Добавить и заменить файлы",
        "update_only_update": "Обновить существующие файлы",
        "update_synchronize": "Синхронизировать",
        "update_add_no_replace": "Добавить файлы (не заменять существующие)",
        "password_label": "Пароль:",
        "password_repeat_label": "Повторить пароль:",
        "encrypt_filenames_checkbox": "Зашифровать имена файлов",
        "show_password_checkbox": "Показать пароль",
        "solid_block_checkbox": "Архивирование сплошных блоков",
        "split_volumes_checkbox": "Разделить на тома",
        "split_placeholder": "Выберите или введите размер",
        "ok_button": "Архивировать",
        "cancel_button": "Отмена",
        "about_button": "О программе",
        "language_button": "Язык (En/Uk/Ru/Tr)",
        "password_mismatch_title": "Несоответствие пароля",
        "password_mismatch_message": "Пароли не совпадают!",
        "options_summary_title": "Сводка параметров",
        "summary_source_files": "--- Исходные файлы/папки ---",
        "summary_selected_items": "Выбранные элементы:",
        "summary_archive_settings": "--- Настройки архива ---",
        "summary_archive_path": "Путь к архиву:",
        "summary_archive_format": "Формат архива:",
        "summary_compression_settings": "--- Настройки сжатия ---",
        "summary_compression_level": "Уровень сжатия:",
        "summary_compression_method": "Метод сжатия:",
        "summary_dictionary_size": "Размер словаря:",
        "summary_cpu_threads": "Потоки ЦП:",
        "summary_archive_options": "--- Параметры архивирования ---",
        "summary_update_mode": "Режим обновления:",
        "summary_password_set": "Установлены пароли:",
        "summary_encrypt_filenames": "Зашифровать имена файлов:",
        "summary_solid_block": "Архивирование сплошными блоками:",
        "summary_split_volumes": "Разделить на тома:",
        "summary_split_size": "Размер разделения:",
        "summary_none": "Нет",
        "summary_start_compression": "Сжатие начнется с этими настройками.",
        "no_source_selected": "Файлы или папки не выбраны.",
        "compression_command_success_title": "Архив успешно архивирован",
        "compression_command_success_message": "Архив успешно создан!",
        "compression_command_error_title": "Ошибка архивирования",
        "compression_command_error_message": "Произошла ошибка во время архивирования:",
        "command_not_found_message": "Команда 7z не найдена. Убедитесь, что p7zip-full установлен и 7z добавлен в PATH.",
        "progress_dialog_title": "Ход архивирования",
        "progress_label_text_initial": "Идет архивирование...",
        "progress_status_label": "Статус:",
        "cancel_compression_button": "Отмена",
        "default_archive_basename": "новый_архив"
    },
    "tr": {
        "window_title": "7Zip GUI",
        ...
        "language_button": "Dil (En/Uk/Ru/Tr)",
...
class SevenZipWorker(QThread):
    ...
    def run(self):
        try:
            ...
            if self._is_canceled:
                self.error.emit("The transaction was canceled by the user.")
                return

            if process.returncode == 0:
                self.finished.emit("Archiving was successfully completed.")
            else:
                self.error.emit(f"The 7z command terminated with an error (Exit code: {process.returncode}).\nError:\n{stderr_output}")

        except FileNotFoundError:
            self.command_not_found.emit("The 7z command was not found. Please ensure that 7-Zip is installed and in your system PATH.")
